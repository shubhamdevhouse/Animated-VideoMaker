        ...
        try {
                            ...
                            if (user["blockList"][blockId].increment >= secondAnimStart) {
                                ...
                                for (let ieg = 0; ieg < currentLine; ieg++) {
                                    ...
                                    if (ieg < currentLine - 1) {
                                        textYAxis += 20+(+(user["blockList"][blockId].linesListMain[ieg + 1]["nDescentLine"]))
                                    }
                                }
            ...
            const onMessage = function (msg) {
                try {
                    ...
                    if (Config.users[data.id].processedVideos >= Config.users[data.id].totalVideos) {
            ...
            const queuefunction = function (err1, eq) {
                ...
                Config.ch.consume(eq.queue, onMessage.bind(this), {
                    noAck: true
